...
use App\Service\Historique_profsService;
use DB;
class Historique_profsController extends Controller
{
     /**
     ...
     * @return void
     */
    public function __construct(Historique_profsService $service)
    {
